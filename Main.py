...
model.add(DLLayer("#1", 50, (X_train.shape[0],), "trim_tanh", W_init1, 0.01, "adaptive"))
model.add(DLLayer("#2", 20, (50,), "trim_tanh", W_init2, 0.01, "adaptive"))
model.add(DLLayer("#3", 20, (20,), "trim_tanh", W_init3, 0.01, "adaptive"))
model.add(DLLayer("#4", 10, (20,), "trim_tanh", W_init4, 0.01, "adaptive"))
model.add(DLLayer("#5", 10, (10,), "trim_tanh", W_init5, 0.01, "adaptive"))
model.add(DLLayer("softmax", 8, (10,), "trim_softmax", W_init6, 0.01, "adaptive"))
